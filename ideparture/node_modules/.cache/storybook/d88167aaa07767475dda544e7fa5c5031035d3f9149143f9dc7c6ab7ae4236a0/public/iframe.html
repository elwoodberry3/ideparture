<!doctype html><html lang="en"><head><meta charset="utf-8"><title>Webpack App</title><meta name="viewport" content="width=device-width,initial-scale=1"><style>@font-face {
    ...
    console.warn('unable to connect to top frame for connecting dev tools');
  }</script><link href="vendors-node_modules_storybook_addon-docs_dist_preview_mjs-node_modules_storybook_addon-essen-96fe98.ed2cd9b1ffa8e8a86224.css" rel="stylesheet"><link href="main.9d2b44c69c2396a9df3c.css" rel="stylesheet"><style>#storybook-root[hidden],
      #storybook-docs[hidden] {
        display: none !important;
            ...
            window['STORIES'] = [{"titlePrefix":"","directory":"./src","files":"**/*.mdx","importPathMatcher":"^\\.[\\\\/](?:src(?:\\/(?!\\.)(?:(?:(?!(?:^|\\/)\\.).)*?)\\/|\\/|$)(?!\\.)(?=.)[^/]*?\\.mdx)$"},{"titlePrefix":"","directory":"./src","files":"**/*.stories.@(js|jsx|mjs|ts|tsx)","importPathMatcher":"^\\.[\\\\/](?:src(?:\\/(?!\\.)(?:(?:(?!(?:^|\\/)\\.).)*?)\\/|\\/|$)(?!\\.)(?=.)[^/]*?\\.stories\\.(js|jsx|mjs|ts|tsx))$"},{"titlePrefix":"","directory":"./src/stories","files":"Introduction.mdx","importPathMatcher":"^\\.[\\\\/](?:src\\/stories\\/Introduction\\.mdx)$"}];
      ...
      import './vendors-node_modules_storybook_addon-docs_dist_preview_mjs-node_modules_storybook_addon-essen-96fe98.iframe.bundle.js';
