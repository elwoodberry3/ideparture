...
`),n+=t[s].slice(r).replace(/\\"""/g,'"""');return n}function ae(){for(var e=0|Ce.charCodeAt(ee++);e===9||e===10||e===13||e===32||e===35||e===44||e===65279;e=0|Ce.charCodeAt(ee++))if(e===35)for(;(e=Ce.charCodeAt(ee++))!==10&&e!==13;);ee--}var Es=/[_A-Za-z]\w*/y;function Nt(){var e;if(e=et(Es))return{kind:"Name",value:e}}var x5=/(?:null|true|false)/y,ks=/\$[_A-Za-z]\w*/y,M5=/-?\d+/y,N5=/(?:\.\d+)?[eE][+-]?\d+|\.\d+/y,F5=/\\/g,A5=/"""(?:"""|(?:[\s\S]*?[^\\])""")/y,O5=/"(?:"|[^\r\n]*?[^\\]")/y;function pr(e){var t,n;if(n=et(x5))t=n==="null"?{kind:"NullValue"}:{kind:"BooleanValue",value:n==="true"};else if(!e&&(n=et(ks)))t={kind:"Variable",name:{kind:"Name",value:n.slice(1)}};else if(n=et(M5)){var r=n;(n=et(N5))?t={kind:"FloatValue",value:r+n}:t={kind:"IntValue",value:r}}else if(n=et(Es))t={kind:"EnumValue",value:n};else if(n=et(A5))t={kind:"StringValue",value:S5(n.slice(3,-3)),block:!0};else if(n=et(O5))t={kind:"StringValue",value:F5.test(n)?JSON.parse(n):n.slice(1,-1),block:!1};else if(t=function(i){var o;if(Ce.charCodeAt(ee)===91){ee++,ae();for(var l=[];o=pr(i);)l.push(o);if(Ce.charCodeAt(ee++)!==93)throw Le("ListValue");return ae(),{kind:"ListValue",values:l}}}(e)||function(i){if(Ce.charCodeAt(ee)===123){ee++,ae();for(var o=[],l;l=Nt();){if(ae(),Ce.charCodeAt(ee++)!==58)throw Le("ObjectField");ae();var s=pr(i);if(!s)throw Le("ObjectField");o.push({kind:"ObjectField",name:l,value:s})}if(Ce.charCodeAt(ee++)!==125)throw Le("ObjectValue");return ae(),{kind:"ObjectValue",fields:o}}}(e))return t;return ae(),t}function ws(e){var t=[];if(ae(),Ce.charCodeAt(ee)===40){ee++,ae();for(var n;n=Nt();){if(ae(),Ce.charCodeAt(ee++)!==58)throw Le("Argument");ae();var r=pr(e);if(!r)throw Le("Argument");t.push({kind:"Argument",name:n,value:r})}if(!t.length||Ce.charCodeAt(ee++)!==41)throw Le("Argument");ae()}return t}function On(e){var t=[];for(ae();Ce.charCodeAt(ee)===64;){ee++;var n=Nt();if(!n)throw Le("Directive");ae(),t.push({kind:"Directive",name:n,arguments:ws(e)})}return t}function L5(){var e=Nt();if(e){ae();var t;if(Ce.charCodeAt(ee)===58){if(ee++,ae(),t=e,!(e=Nt()))throw Le("Field");ae()}return{kind:"Field",alias:t,name:e,arguments:ws(!1),directives:On(!1),selectionSet:Ur()}}}function Cs(){var e;if(ae(),Ce.charCodeAt(ee)===91){ee++,ae();var t=Cs();if(!t||Ce.charCodeAt(ee++)!==93)throw Le("ListType");e={kind:"ListType",type:t}}else if(e=Nt())e={kind:"NamedType",name:e};else throw Le("NamedType");return ae(),Ce.charCodeAt(ee)===33?(ee++,ae(),{kind:"NonNullType",type:e}):e}var T5=/on/y;function Ss(){if(et(T5)){ae();var e=Nt();if(!e)throw Le("NamedType");return ae(),{kind:"NamedType",name:e}}}var _5=/\.\.\./y;function Z5(){if(et(_5)){ae();var e=ee,t;if((t=Nt())&&t.value!=="on")return{kind:"FragmentSpread",name:t,directives:On(!1)};ee=e;var n=Ss(),r=On(!1),i=Ur();if(!i)throw Le("InlineFragment");return{kind:"InlineFragment",typeCondition:n,directives:r,selectionSet:i}}}function Ur(){var e;if(ae(),Ce.charCodeAt(ee)===123){ee++,ae();for(var t=[];e=Z5()||L5();)t.push(e);if(!t.length||Ce.charCodeAt(ee++)!==125)throw Le("SelectionSet");return ae(),{kind:"SelectionSet",selections:t}}}var I5=/fragment/y;function R5(){if(et(I5)){ae();var e=Nt();if(!e)throw Le("FragmentDefinition");ae();var t=Ss();if(!t)throw Le("FragmentDefinition");var n=On(!1),r=Ur();if(!r)throw Le("FragmentDefinition");return{kind:"FragmentDefinition",name:e,typeCondition:t,directives:n,selectionSet:r}}}var B5=/(?:query|mutation|subscription)/y;function P5(){var e,t,n=[],r=[];(e=et(B5))&&(ae(),t=Nt(),n=function(){var o,l=[];if(ae(),Ce.charCodeAt(ee)===40){for(ee++,ae();o=et(ks);){if(ae(),Ce.charCodeAt(ee++)!==58)throw Le("VariableDefinition");var s=Cs(),c=void 0;if(Ce.charCodeAt(ee)===61&&(ee++,ae(),!(c=pr(!0))))throw Le("VariableDefinition");ae(),l.push({kind:"VariableDefinition",variable:{kind:"Variable",name:{kind:"Name",value:o.slice(1)}},type:s,defaultValue:c,directives:On(!0)})}if(Ce.charCodeAt(ee++)!==41)throw Le("VariableDefinition");ae()}return l}(),r=On(!1));var i=Ur();if(i)return{kind:"OperationDefinition",operation:e||"query",name:t,variableDefinitions:n,directives:r,selectionSet:i}}function V5(e,t){return Ce=typeof e.body=="string"?e.body:e,ee=0,function(){var n;ae();for(var r=[];n=R5()||P5();)r.push(n);return{kind:"Document",definitions:r}}()}function j5(e){return JSON.stringify(e)}function D5(e){return`"""
`+e.replace(/"""/g,'\\"""')+`
...
`).replace(/\n/g,`
  `)+`
)`:r}return at(e.directives)&&(t+=" "+e.directives.map(Ve.Directive).join(" ")),e.selectionSet?t+" "+Ve.SelectionSet(e.selectionSet):t},StringValue:e=>e.block?D5(e.value):j5(e.value),BooleanValue:e=>""+e.value,NullValue:e=>"null",IntValue:e=>e.value,FloatValue:e=>e.value,EnumValue:e=>e.value,Name:e=>e.value,Variable:e=>"$"+e.name.value,ListValue:e=>"["+e.values.map(rt).join(", ")+"]",ObjectValue:e=>"{"+e.fields.map(Ve.ObjectField).join(", ")+"}",ObjectField:e=>e.name.value+": "+rt(e.value),Document:e=>at(e.definitions)?e.definitions.map(rt).join(`
...
`)),l+=m+r[c+1]}),l}var K4=w.div(({theme:e})=>({"&& > *":{margin:0},"&& pre":{color:e.base==="light"?e.color.darker:e.color.lighter,background:e.base==="light"?e.color.lightest:e.color.darkest,fontSize:"12px",lineHeight:"16px",textAlign:"left",padding:"15px !important"}})),J4="https://www.chromatic.com/docs/visual-tests-addon/#configure";function X4({projectId:e,configFile:t}){return nt("LinkProject","LinkingProjectFailed"),a.createElement(Ne,null,a.createElement(ye,null,a.createElement(de,null,a.createElement("div",null,a.createElement(fe,null,"Add the project ID to your Chromatic config"),a.createElement(q,{center:!0,muted:!0},"The ",a.createElement(He,null,"projectId")," will be used to sync tests with Chromatic. Please commit this change to continue using the addon. The file should be saved at"," ",a.createElement(He,null,t),".")),a.createElement(K4,null,a.createElement(He,null,Q4`
              ...
              `)),a.createElement($e,{secondary:!0,withArrow:!0,target:"_blank",href:J4},"What's this for?"))))}var ep=vt(`
  query SelectProjectsQuery {
    viewer {
      accounts {
        id
